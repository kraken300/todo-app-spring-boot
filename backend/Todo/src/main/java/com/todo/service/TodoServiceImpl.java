...
public class TodoServiceImpl implements TodoService {
	...
	@Override
	public List<Todo> filterTodosByCheck(boolean check) {
		Todo todo = new Todo();
		todo.setIsCompleted(check);
		Example<Todo> filter = Example.of(todo);
		List<Todo> allTodos = todoDAO.findAllTodos(filter);
		return allTodos;
	}
